...
class Settings:
    ...
    MODEL_NAME: str = os.getenv("MODEL_NAME", "phi-3.5-mini")
    MODEL_FILE: str = os.getenv("MODEL_FILE", "Phi-3.5-mini-instruct-Q4_K_M.gguf")
    MODEL_PATH: str = os.getenv(
        "MODEL_PATH",
        str(Path(__file__).resolve().parent.parent / "models" / os.getenv("MODEL_FILE", "Phi-3.5-mini-instruct-Q4_K_M.gguf")),
    )
    MODEL_URL: str = os.getenv("MODEL_URL", "https://huggingface.co/bartowski/Phi-3.5-mini-instruct-GGUF/resolve/main/Phi-3.5-mini-instruct-Q4_K_M.gguf")
